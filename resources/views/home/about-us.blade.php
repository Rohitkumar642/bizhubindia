...
<section class="testimonial_section_two financer-test-section aos-init aos-animate" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="500">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-xs-12 content_column">
				<div class="testimonial_content aos-init aos-animate">
					<div class="section_title">
						<div class="tag_text"><h6>Testimonials</h6></div>                                
						<h2>Love from Clients</h2>
					</div>
					<div class="single-item-carousel owl-carousel owl-theme" id="five-item-carousel">
						<div class="item">
							<div class="testimonial_block_three">
								<div class="inner_box">
									<div class="quort_icon"><i class="fa fa-quote-left"></i></div>
									<p class="text">We will assist in the establishment of the legal entities, working with the Fund and Sponsor's advisers to prepare bespoke documentation, supporting you get you smoothly through to launch.</p>
								</div>
							</div>
						</div>
						<div class="item">
			...
			<div class="col-md-6 col-xs-12 image_column">
				<figure class="testimonial_image float-bob-y">
					<img decoding="async" src="img/testimonial-4.png" alt="Awesome Image">
				</figure>
			</div>
		</div>
	</div>    
