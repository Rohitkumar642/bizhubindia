 ...
 <div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-xs-12 wow fadeInDown animated">
			<div class="contact_block_one mb_30 aos-init aos-animate" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="550">
                <div class="contact_block_icon te-icon"><i class="fa fa-envelope"></i></div>
                <div class="contact_block_title"><h4 class="te-title">Email Address</h4></div>
				<div class="contact_block_text"><p class="te-text"><a href="mailto:support@antworksmoney.com">support@antworksmoney.com</a></p></div>
			</div>
		</div>
		
		<div class="col-md-4 col-xs-12 wow fadeInDown animated">
			<div class="contact_block_one mb_30 aos-init aos-animate" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="600">
                <div class="contact_block_icon te-icon"><i class="fa fa-phone"></i></div>
                <div class="contact_block_title"><h4 class="te-title">Phone Number</h4></div>
				<div class="contact_block_text"><p class="te-text"><a href="tel:+0124-6526008">+0124-6526008</a></p></div>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12 col-xs-12 wow fadeInDown animated contact-head">
		  <div class="tag_text">
			 <h6 class="te-subtitle">Contact</h6>
		  </div>
		  <h2 class="choose-hd">Contact Us</h2>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12">
            <div class="form-group">
                <textarea id="message" class="form-control" placeholder="Type message" rows="4" required></textarea>
            </div>
        </div>
        <div class="col-xl-12 col-md-12 col-sm-12">
            <div class="form-group centred">
                <button type="button" id="sendMessage" class="btn_style_one yt-btn-title-v1">Send Message</button>
            </div>
        </div>
    </div>
</div>
